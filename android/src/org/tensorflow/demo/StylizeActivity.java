...
public class StylizeActivity extends CameraActivity implements OnImageAvailableListener {
    ...
    public int i = 0;
    public int[] songs = {R.raw.blood, R.raw.camila, R.raw.senorita, R.raw.thenight};
    ...
    private static final Size DESIRED_PREVIEW_SIZE = new Size(1280, 50);
...
//    jcAudios.add(JcAudio.createFromRaw("Blood", R.raw.blood));
//    jcplayerView.initAnonPlaylist(jcAudios);
        final MediaPlayer mplayer = MediaPlayer.create(this, R.raw.sen);
        final ImageButton imgbtn = (ImageButton) findViewById(R.id.play);
        imgbtn.setBackgroundResource(R.drawable.pl);
        ...
        imgbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (mplayer.isPlaying()) {
                    mplayer.pause();
                    v.setBackgroundResource(R.drawable.pl);
                } else {
                    mplayer.start();
                    v.setBackgroundResource(R.drawable.pa);
                }
            }
        });
    }
